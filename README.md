...
* [ForgeFed](https://github.com/forgefed/forgefed) - a decentralized federation protocol that provides a server-to-server API for pull request, forking and subscription.
...
* [Hypercore Protocol](https://hypercore-protocol.org/) - a fast, scalable, and secure peer-to-peer protocol for everyone (evolution of the [Dat Protocol](https://datproject.org))
